...
class Product(models.Model):
    ...
    art_name = models.CharField('Nazwa artykułu', max_length=255)
    ...
    rtveuro_url = models.CharField('Link do RTVEuroAGD', null=True, blank=True)

    mediamarkt_price = models.FloatField('Cena Media Markt', null=True, blank=True)
    mediamarkt_url = models.CharField('Link do Media Markt', null=True, blank=True)

    mediaexpert_price = models.FloatField('Cena Media Expert', null=True, blank=True)
    mediaexpert_url = models.CharField('Link do Media Expert', null=True, blank=True)
...
class Category(models.Model):
    ...
    category_name = models.CharField('Kategoria', max_length=255)
